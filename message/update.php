...
<div id="bbs">
    ...
    <ul>
        <li>
            <span>用户名称</span>
            <input class="msg" type="text" value="<?php echo $row['uName']; ?>" name="uName" placeholder="请输入用户名">
        </li>
        <li>
            <span>用户头像</span>
            <?php
        ...
        <li><span>留言标题</span>
            <input class="msg" type="text" value="<?php echo $row['sTitle']; ?>" name="sTitle" /></li>
        <li>
            <span class="mid">留言内容</span> 
            <textarea name="con" cols="60" rows="10"><?php echo $row['con']; ?></textarea>
        </li>
